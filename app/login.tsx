    ...
    >
      ...
      >
        <View className="flex-col gap-8">
          ...
          <Text className="text-lg text-gray-500">Lorem ipsum dolor sit amet consectetur adipisicing elit. Incidunt autem sit deleniti!!</Text>
        </View>

        <View className="flex-col my-6 pt-4 gap-6">
          <Text className="text-2xl font-bold">Sign in</Text>
          <TextInput placeholder="Email" className="w-full border-none bg-white rounded-xl p-5" />
          <TextInput placeholder="Code" className="w-full border-none bg-white rounded-xl p-5" />
        </View>
        ...
        <View className="flex-col my-6 gap-6">
          ...
          >
            <Text className="text-center text-gray-800 text-lg font-bold">No Account? Join in</Text>
          </TouchableOpacity>
        </View>
